...
namespace DistanceCalculator.Tests
{
    ...
    {
        [TestFixture]
        class WhenInvokingForStartEndAndLessThanOrEqual
        {
            ...
            [Test]
            public void HandlesOneTraverserResult()
            {
                var graph = new Dictionary<string, int>();
                const string myPath = "AZ";
            ...
            [Test]
            public void HandlesTwoTraverserResultNoMatch()
            {
                var graph = new Dictionary<string, int>();
                const string myPath = "AZ";

                var oneResult = new List<List<string>> { new List<string> { "AB", "BA" } };
            ...
            [Test]
            public void HandlesTwoTraverserResultMatches()
            {
                var graph = new Dictionary<string, int>();
                const string myPath = "AZ";

                var oneResult = new List<List<string>> { new List<string> { "AZ", "ZA" } };
